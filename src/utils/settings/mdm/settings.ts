/**
 * MDM (Mobile Device Management) profile enforcement for Momo Code managed settings.
 *
 ...
 * - Windows: `HKLM\SOFTWARE\Policies\MomoCode` (admin-only)
 *   and `HKCU\SOFTWARE\Policies\MomoCode` (user-writable, lowest priority)
