export const BASE_CHROME_PROMPT = `# Momo in Chrome browser automation
...
/**
 * Minimal hint about Momo in Chrome skill availability. This is injected at startup when the extension is installed
