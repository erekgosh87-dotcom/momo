 ...
 *
 * The parent momo process keeps these vars (needed for API calls, lazy
...
const GHA_SUBPROCESS_SCRUB = [
  // Anthropic auth — momo re-reads these per-request, subprocesses don't need them
  'ANTHROPIC_API_KEY',
  ...
  // GitHub Actions OIDC — consumed by the action's JS before momo spawns;
