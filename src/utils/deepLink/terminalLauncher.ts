 ...
 * Terminal Launcher
 *
 * Detects the user's preferred terminal emulator and launches Momo Code
...
/**
 * Launch Momo Code in the detected terminal emulator.
 *
...
async function launchWindowsTerminal(
  ...
  switch (terminal.name) {
    ...
    // mode that also keeps the session interactive after momo exits.
