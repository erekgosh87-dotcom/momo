...
/**
 * Map LSP severity to Momo diagnostic severity
 *
 * Maps LSP severity numbers to Momo diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to Momo diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by Momo's attachment system.
 */
 ...
 * from all LSP servers and routes them to Momo's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to Momo format (can throw on invalid URIs)
