...
async function _temp2() {
  ...
  const subscriptionType = await getExistingMomoSubscription();
  ...
  return {
    ...
    jsx: <Text color="suggestion">Use your existing Momo {subscriptionType} plan with Momo Code<Text color="text" dimColor={true}>{" "}· /login to activate</Text></Text>,
    priority: "low"
  };
}
...
async function getExistingMomoSubscription(): Promise<'Max' | 'Pro' | null> {
