...
const NPM_DEPRECATION_MESSAGE = 'Momo Code has switched from npm to native installer. Run `momo install` or see https://docs.anthropic.com/en/docs/claude-code/getting-started for more options.';
