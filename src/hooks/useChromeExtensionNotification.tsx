...
import { isChromeExtensionInstalled, shouldEnableMomoInChrome } from '../utils/claudeInChrome/setup.js';
...
async function _temp() {
  ...
  if (!shouldEnableMomoInChrome(chromeFlag)) {
    return null;
  }
  if (true && !isMomoAISubscriber()) {
    return {
      key: "chrome-requires-subscription",
      jsx: <Text color="error">Momo in Chrome requires a claude.ai subscription</Text>,
      priority: "immediate",
      timeoutMs: 5000
    };
  }
  ...
  if (chromeFlag === undefined) {
    return {
      ...
      text: "Momo in Chrome enabled \xB7 /chrome",
      priority: "low"
    };
  }
  return null;
