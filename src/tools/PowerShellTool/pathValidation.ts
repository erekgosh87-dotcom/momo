...
function checkPathConstraintsForStatement(
  ...
  // Runtime writes /project/.claude/settings.json (Momo's permission config).
  //
      ...
      if (!allowed) {
        ...
        const message =
          ...
          decisionReason?.type === 'safetyCheck'
            ...
            : `${canonical} targeting '${resolvedPath}' was blocked. For security, Momo Code may only access files in the allowed working directories for this session: ${dirListStr}.`
