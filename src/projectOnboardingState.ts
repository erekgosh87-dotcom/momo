...
export function getSteps(): Step[] {
  const hasMomoMd = getFsImplementation().existsSync(
    join(getCwd(), 'MOMO.md'),
  )
  ...
  return [
    {
      key: 'workspace',
      text: 'Ask Momo to create a new app or clone a repository',
      isComplete: false,
      isCompletable: true,
    ...
    {
      key: 'claudemd',
      text: 'Run /init to create a MOMO.md file with instructions for Momo',
      isComplete: hasMomoMd,
      isCompletable: true,
      isEnabled: !isWorkspaceDirEmpty,
    },
  ]
