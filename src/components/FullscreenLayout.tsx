 ...
 * users think of as "a new message from Momo" — not raw assistant entries
 ...
 * until Momo's text response lands.
 */
...
// conversation turn's prompt above the viewport so you know what Momo was
