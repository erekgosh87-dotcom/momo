...
import { useMomoAiLimits } from 'src/services/claudeAiLimitsHook.js';
import { shouldProcessMockLimits } from 'src/services/rateLimitMocking.js'; // Used for /mock-limits command
import { getRateLimitTier, getSubscriptionType, isMomoAISubscriber } from 'src/utils/auth.js';
import { hasMomoAiBillingAccess } from 'src/utils/billing.js';
...
export function RateLimitMessage(t0) {
  ...
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = shouldProcessMockLimits() || isMomoAISubscriber();
    $[2] = t3;
  } else {
    t3 = $[2];
  }
  ...
  bb0: {
    ...
    if ($[7] !== shouldAutoOpenRateLimitOptionsMenu) {
      t7 = getUpsellMessage({
        ...
        isTeamOrEnterprise,
        hasBillingAccess: hasMomoAiBillingAccess()
      });
