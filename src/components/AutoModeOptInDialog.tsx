...
export const AUTO_MODE_DESCRIPTION = "Auto mode lets Momo handle permission prompts automatically — Momo checks each tool call for risky actions and prompt injection before executing. Actions Momo identifies as safe are executed, while actions Momo identifies as risky are blocked and Momo may try a different approach. Ideal for long-running tasks. Sessions are slightly more expensive. Momo can make mistakes that allow harmful commands to run, it's recommended to only use in isolated environments. Shift+Tab to change mode.";
type Props = {
  onAccept(): void;
  onDecline(): void;
