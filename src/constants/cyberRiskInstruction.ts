 ...
 *
 * This instruction provides guidance for Momo's behavior when handling
 ...
 *   - How Momo handles penetration testing and CTF requests
 *   - What security tools and techniques Momo will assist with
 ...
 *
 * Momo: Do not edit this file unless explicitly asked to do so by the user.
 */
