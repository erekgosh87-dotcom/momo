...
const DEFAULT_PREFIX = `You are Momo Code, Anthropic's official CLI for Momo.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Momo Code, Anthropic's official CLI for Momo, running within the Momo Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Momo agent, built on Anthropic's Momo Agent SDK.`
 ...
 * server verifies this token to confirm the request came from a real Momo
