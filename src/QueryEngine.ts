...
export class QueryEngine {
  ...
  async *submitMessage(
    ...
    // a memory directory and needs Momo to know how to use it (which
...
/**
 * Sends a single prompt to the Momo API and returns the response.
 * Assumes that momo is being used non-interactively -- will not
