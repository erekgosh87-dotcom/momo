 ...
 * persists. On next startup, `momo remote-control` detects it and offers
 ...
 * and handles errors — no existence check (MOMO.md TOCTOU rule). Returns
 ...
 * mutate to a worktree path — but `momo remote-control --continue` runs
