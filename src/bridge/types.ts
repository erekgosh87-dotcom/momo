...
/** Full error printed when `momo remote-control` is run without auth. */
...
/**
 * How `momo remote-control` chooses session working directories.
...
export type BridgeConfig = {
   ...
   * instead of creating a new one. Used by `momo remote-control
